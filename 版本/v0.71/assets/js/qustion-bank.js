$(document).ready(function(){
    ...
    function createQustionDom(qusIndex = 0,qusContent = {
        ...
        <div class="accordion-item">
            ...
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse${qusContent["qusIndex"]}" aria-expanded="true" aria-controls="collapse${qusContent["qusIndex"]}">
              ...
              <div class="edit-qus" edit-mode="false" qusbank-id="${qusContent["qusbankId"]}"  qus-index="${qusContent["qusIndex"]}" style="margin-right: 10px;">
    ...
    const qustionCon = $(".qustion-con");
    

    qustionbankCon.on("click",".qus-bank",qusBankClick);
    //選擇題庫
    // qusBank.click(qusBankClick);
    ...
    //編輯題目
    // editQusBtn.click(editQusBtnClick);
    qustionCon.on("click",".edit-qus",editQusBtnClick);
    ...
    function deleteQusBankBtnClick(){
        ...
        let qusBankName = $(this).closest(".qus-bank")
                            ...
                            .text();
        //取得題目數量
        let qusbankNumber = $(this).closest(".qus-bank")
                            .find(".qustionbank-number")
                            .attr("number");
    ...
    function DeleteQusBankYesClick(){
        // 取得刪除的題庫id
        let deleteQusBankId = $(this).closest(".delete-quetionbank-con")
        .attr("deleteQusBankId");
